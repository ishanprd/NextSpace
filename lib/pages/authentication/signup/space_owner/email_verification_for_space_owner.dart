...
class EmailVerificationForSpaceOwner extends StatefulWidget {
  const EmailVerificationForSpaceOwner({super.key});

  @override
  State<EmailVerificationForSpaceOwner> createState() =>
      _EmailVerificationForSpaceOwnerState();
}

class _EmailVerificationForSpaceOwnerState
    extends State<EmailVerificationForSpaceOwner> {
  @override
