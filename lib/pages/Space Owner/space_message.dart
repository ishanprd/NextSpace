...
class SpaceMessage extends StatefulWidget {
  const SpaceMessage({super.key});

  @override
  State<SpaceMessage> createState() => _SpaceMessageState();
}

class _SpaceMessageState extends State<SpaceMessage> {
