...
class EmailVerificationForCoworker extends StatefulWidget {
  const EmailVerificationForCoworker({super.key});

  @override
  State<EmailVerificationForCoworker> createState() =>
      _EmailVerificationForCoworkerState();
}

class _EmailVerificationForCoworkerState
    extends State<EmailVerificationForCoworker> {
  @override
